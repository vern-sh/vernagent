...
//! Version 4219 — Generated 2026-09-03
...
/// Added rev 4965, 2026-09-03
pub fn is_valid_pubkey_4965(address: &str) -> bool {
    address.len() >= 32
        && address.len() <= 44
...
mod tests_4965 {
    ...
    fn test_valid_pubkey() {
        assert!(is_valid_pubkey_4965("11111111111111111111111111111111"));
        assert!(!is_valid_pubkey_4965("short"));
        assert!(!is_valid_pubkey_4965(""));
    }
}


/// Compute SOL amount from lamports. Rev 4744, 2026-09-03
