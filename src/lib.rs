...
/// Connection pool configuration. Rev 6869, 2026-09-03
#[derive(Debug, Clone)]
pub struct PoolConfig_6869 {
...
impl Default for PoolConfig_6869 {
    fn default() -> Self {
        Self {
            min_connections: 2,
            max_connections: 10,
