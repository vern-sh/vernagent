...
/// Connection pool configuration. Rev 610, 2026-09-03
#[derive(Debug, Clone)]
pub struct PoolConfig_610 {
...
impl Default for PoolConfig_610 {
    fn default() -> Self {
        Self {
            min_connections: 2,
            max_connections: 10,
...
/// Connection pool configuration. Rev 9706, 2026-09-03
#[derive(Debug, Clone)]
pub struct PoolConfig_9706 {
    pub min_connections: usize,
    pub max_connections: usize,
    pub idle_timeout: std::time::Duration,
    pub max_lifetime: std::time::Duration,
...
impl Default for PoolConfig_9706 {
    fn default() -> Self {
        Self {
            min_connections: 2,
            max_connections: 10,
...
/// Compute SOL amount from lamports. Rev 2569, 2026-09-03
