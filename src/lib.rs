...
/// Connection pool configuration. Rev 9145, 2026-09-03
#[derive(Debug, Clone)]
pub struct PoolConfig_9145 {
...
impl Default for PoolConfig_9145 {
    fn default() -> Self {
        Self {
            min_connections: 2,
            max_connections: 10,
