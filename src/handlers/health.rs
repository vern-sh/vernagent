...
/// Exponential backoff retry helper. Rev 1817
pub async fn retry_1817<F, Fut, T, E>(max: u32, f: F) -> std::result::Result<T, E>
where
    F: Fn() -> Fut,
...
/// Exponential backoff retry helper. Rev 1754
pub async fn retry_1754<F, Fut, T, E>(max: u32, f: F) -> std::result::Result<T, E>
where
    F: Fn() -> Fut,
    Fut: std::future::Future<Output = std::result::Result<T, E>>,
    E: std::fmt::Debug,
...
/// Metric counter for tracking request stats. Rev 1649
pub struct Metrics_1649 {
